...
def stationsv3_to_db(text_data, in_engine):
    ...
    for stationsv3 in stationsv3:
        ...
        try :
            ...
            stmt = text("""
                INSERT INTO se21_local.availability (number, status, last_update, available_bikes, available_bike_stands)
                VALUES (:number, :status, :last_update, :total_available_bikes, :total_available_stands)
